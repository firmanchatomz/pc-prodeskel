...
function date_indo($tgl) {
	if ($tgl != '0000-00-00') {
		$divide 	= dividedate($tgl);
		return $divide['date'].' '.bulan_indo($divide['month']).' '.$divide['year'];
	}
}

## memisahkan bagian tanggal
function dividedate($tgl){
	if ($tgl != '0000-00-00') {
...
function getdateofdate($tgl) {
	$divide 	= dividedate($tgl);
	return $divide['date'];
}

// mengambil bulan dari tanggal
function getmonthofdate($tgl) {
	$divide 	= dividedate($tgl);
	return $divide['month'];
}

// mengambil tahun dari tanggal
function getyearofdate($tgl) {
	$divide 	= dividedate($tgl);
	return $divide['year'];
}
